...
define gui.about = _("This mod contains free artwork and creations from the Doki Doki Modding Club, all of which are credited by their Discord names below.\n\nMusic:\nCredits Song: Sayonara Remix - Singularity#5161\n\nBackgrounds:\nSchool on Fire: Cyrke#8043\nCoffee Shop: mugenjohncel (No Discord)\n\nThank you to the creators of the Mood Posing Tool for making it easier to make this mod!\n\nThank you to all the players of the mod, you made this possible!")
...
define build.name = "Yuri-Reality"
...
define config.save_directory = "YuriReality"
