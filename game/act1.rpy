...
label chap2_main:
    ...
    scene class with dissolve_scene_full
    ...
    mc "Wait, how long have you been here"
    s 5a "Uhm"
    s 5a "About 30 minutes"
    mc "..."
    mc "Wait..."
    mc "We need to get to the club!"
    s 4p "{b}[player]! GET TO THE CLUBROOM{/b}"
    mc "That was the worst Terminator impression that I have ever heard."
    s 1q "Thank you!"
    mc "Let's just go"
    s 1q "Good idea, ehehe"
    scene club with wipeleft
    stop music
    play music t3
    show monika 3b zorder 3 at t11
    m 3b  "[player]! Glad to see you didn't run away from us, just Natsuki is left"
    m 2d  "You are a bit late though..."
    "Oops! Should I tell her I was spacing out or should I say I was at the toilet?!"
    "I don't kno-"
    hide monika
    ...
    s 5d "Stop trying to get yourself out of this, meanie!"
    mc "Okay, I admit it."
    s 4p "See?"
    mc "{i}Shush!{/i}"
    s 5c "Hmph"
...
label yuri_selection_ch2:
     ...
     y 1n "Oh! [player]! You gave me quite a shock!"
     ...
     show yuri 1f zorder 3 at t11
     y "I'm coming, sorry..."
     "The fire alarm is so loud. My ears are already bleeding."
     ...
     m 1f "Behind me."
     mc "Oh my god."
     "The east wing of the school is completely engulfed in flames."
     "Where's Natsuki?"
     ...
     n 5g "Ugh."
     teacher "Okay guys, this isn't looking good."
     teacher "I want you all to go home and wait for news on what will happen with you all."
     ...
     mc "Yup, me. Sorry about that."
     y 2p "No, it's amaz-"
     y "It's fine, sorry if I implied that I was ungrateful"
     mc "Don't worry, I was only joking."
     y 2l "Phew!"
     hide yuri
     hide sayori
     ...
     show sayori 4m at t33 zorder 3
     s 4m "MONIKA!!! OMG WE'RE SHARING A BED! THIS IS THE BEST DAY EVER!!!!!!!"
     mc "Excuse me??"
     s 5b "Ehehe, nothing."
     scene livingroom with wipeleft
     "The night turned into watching the Insidious movies on Netflix, Sayori fell off the sofa three times"
     ...
     show yuri 1k at t11 zorder 3
     y 1f "What?"
     mc "Yuri. Wake up."
     y "Do I have to?"
     mc "Unfortunately, yes. We need to wake up the rest of the girls."
     y 1d "One sec"
   ##  $ consolehistory = []
   ##  call updateconsole ("os.wake(\"characters/monika.chr\")", "monika.chr woken successfully.")
   ##  call updateconsole ("os.wake(\"characters/sayori.chr\")", "sayori.chr woken successfully.")
   ##  call updateconsole ("os.wake(\"characters/natsuki.chr\")", "natsuki.chr woken successfully.")
 
     "As soon as she says that, all of the doors of the other rooms open at the same time"
   ##   call hideconsole
   
     mc "What the hell?"
     y "What?"
     m "Yuri? [player]? Are you up yet?"
     y 3w "We better go down."
     scene kitchen with wipeleft
     show monika forward laug om ce at t41 zorder 3
     show natsuki turned laug om ce at t42 zorder 3
     show sayori turned laug om ce at t43 zorder 3
     show yuri turned curi om oe at t44 zorder 3
     n "And then I told him that he had the toilet paper on his foot"
     n "And he lost it!"
     "Monika, Natsuki and Yuri are telling some sort of funny story."
     mc "You seem to be enjoying yourselves"
     n "Ehe, just telling a story"
     y "Oh"
     mc "Why did you all come in your uniforms?"
     s sad om ce "W-we came here straight after the fire"
     s "We were just coming over to see you for a bit, and then Monika sent the message to ask if we could stay over." 
     m sad om ce "Still no updates on the school situation."
     y happ om oe "So what do you guys want to do today?"
     n happ om ce "We could go to the mall"
     mc "Ew, shopping"
     m happ om oe "What about getting some coffee?"
     y "I like that idea."
     s "We should all go home and get changed into more appropriate clothes"
     mc "Meet me there in an hour, okay guys?"
     n "Sure"
     y "Sounds good!"
     m "I like your style!"
     s "I'll be next door!"
     mc "Bye girls! See you soon"
     y "Bye [player]!"
     scene coffeeshop with wipeleft
     stop music
     play music t2
     "The girls should be here soon"
     show yuri turned casual rup lup dist cm oe at t11 zorder 3
     y "I think I should tell you what's going on now..."
     hide yuri
     show sayori turned casual rup lup happ om oe at t22 zorder 3
     show yuri turned casual rup lup shoc om oe at t21 zorder 3
     s "Yuri! [player]! You got here before me! I ran as fast as I could to get here first"
     y rdown ldown happ oe cm "O-oh, Sayori. Hi there."
     s "Ehehe, Monika and Natsuki should be here soon!"
     mc "Oh, are they? Good to know"
     s "No problem!"
     y neut oe cm "Should we wait for them to order?"
     mc "It would be rude not to."
     y "Fair enough."
     "At that, Monika and Natsuki both walk through the door."
     show natsuki turned casual happ om oe at t41 zorder 3
     show monika forward happ oe cm casual at t42 zorder 3
     show yuri turned neut rdown ldown casual at t43 zorder 3
     show sayori turned happ oe cm rup lup at t44 zorder 3
     s "Moniiii!"
     m "Sayooooo!"
     n "Oh yeah, I'm good. Thanks for asking"
     mc "Oh Natsuki, didn't see ya there. Just slipped under my vision."
     n angr om oe "Did you just call me small?"
     mc "No..."
     n "Better not have, loser." 
     m laug om ce "I'm gonna go make the order"
     n anno om ce "Cookies and Cream frappucino"
     s lsur rup lup om oe "Did someone say cookies? I'll have that!"
     y neut om ce "I'll have a chai tea, thank you"
     mc "I'll just take a Cold Brew"
     m happ cm oe "Alright, I'll be back in a minute!"
     s happ "I wanna go with you Moniii~"
     m "Noo, you have to look after these idiots"
     s sad cm ce "Pleeease?"
     m laug cm ce "Okay then, hurry up. Be good guys."
     s happ "Bye guys!"
     show sayori at lhide
     show monika at lhide
     hide monika
     hide sayori
     n "They better be quick."
     y "It takes time to make stuff, Natsuki"
     n cross anno om ce "Hmph"
     mc "Welp, let's just wait."
     scene coffeeshop with dissolve_scene_full
     ...
     s "Moniii, can you come over to mine?"
     m "Ehe, of course"
     n "Get a room"
     s tap nerv om ce "Ehehe..."
     m "Well, me and Sayori are gonna go now, isn't that right?"
     s turned happ cm oe "Yeah, let's go!"
     n "I guess I'll go too"
     mc "Alright, bye guys!"
     m "Bye!"
     show natsuki at lhide zorder 3
     show monika at lhide zorder 3
     show sayori at lhide zorder 3
     hide natsuki
     hide monika
     hide sayori
     hide yuri
     show yuri turned dist casual om ce at t11 zorder 3
     stop music
     play music t10
     y "Ok, I guess I can tell you what I've needed to tell you for a while now"
     mc "What's wrong? You can trust me."
     y "I- I can control the world"
     mc "What?"
     y "Look"
     $ consolehistory = []
     call updateconsole ("os.spawn(\"assets\5t331.obj\")", "ERROR: FILE CORRUPT.") from _call_updateconsole_17
     stop music
     play music creeprev
     y pani oe om "Oh no."
